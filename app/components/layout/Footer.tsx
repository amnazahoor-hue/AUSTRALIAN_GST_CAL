...
function SocialLinks() {
  return (
    <div className="social-links">
      <a href="https://twitter.com/ausgstpro" className="social-icon" data-social="twitter" data-tooltip="Twitter" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Twitter">
        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
      </a>
      <a href="https://linkedin.com/company/ausgstpro" className="social-icon" data-social="linkedin" data-tooltip="LinkedIn" target="_blank" rel="noopener noreferrer" aria-label="Follow us on LinkedIn">
      ...
      <a href="https://facebook.com/ausgstpro" className="social-icon" data-social="facebook" data-tooltip="Facebook" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook">
        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
      </a>
      <a href="https://instagram.com/ausgstpro" className="social-icon" data-social="instagram" data-tooltip="Instagram" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Instagram">
      ...
      <a href="https://youtube.com/c/ausgstpro" className="social-icon" data-social="youtube" data-tooltip="YouTube" target="_blank" rel="noopener noreferrer" aria-label="Subscribe on YouTube">
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            ...
            <Link href="/#how-it-works">GST Guide</Link>
            <Link href="/#formula">The Formula</Link>
            <Link href="/#faq">Common Questions</Link>
            <Link href="/#calculator">GST Calculator</Link>
            <Link href="/about-us">About Us</Link>
          </div>
          <div>
            <h3 className="footer-head">Legal</h3>
